...
- Gradle currently contains `versionCode 488` and `versionName "0.488"`; this is the next unreleased version after the verified public `0.487` manifest and is intended for the signed direct/public release. The active Play Alpha remains `0.459` until a deliberate, continuity-safe Play release decision.
