...
- Translation validation pass (2026-09-22): all 28 generated locale drafts were opened and checked against Play's hard 30-character app-name and 80-character short-description limits. The audit found and corrected overlong or brand-inconsistent entries in Spanish (Spain/Latin America), Czech, Hindi, Hungarian, Indonesian, French, Italian, Dutch, Polish, Portuguese (Brazil), Romanian, Russian, Swedish, Thai, Ukrainian, and Vietnamese; corrected short descriptions are 29–80 characters and use `Ampere Battery Lab` consistently. The 31 resulting listing changes were moved back to `Für später gespeichert`; none were submitted or published. Human/native review is still recommended before release.
