...
- Translation validation pass (2026-09-22): all 28 generated locale drafts were opened and checked against Play's hard 30-character app-name and 80-character short-description limits. Overlong or brand-inconsistent entries were corrected in Spanish (Spain/Latin America), Czech, Hindi, Hungarian, Indonesian, French, Italian, Dutch, Polish, Portuguese (Brazil), Romanian, Russian, Swedish, Thai, Ukrainian, and Vietnamese; all checked short descriptions now fit the limit and use `Ampere Battery Lab` consistently. The 31 resulting listing changes were moved back to `Für später gespeichert`; none were submitted or published. Native-language review remains advisable.
